                      ...
                      return GridView.builder(
                        ...
                        itemBuilder: (context, index){
                          ...
                          if(addProductImageController.imagesWithColor[index].color != null){
                            final String colorValue = addProductImageController.imagesWithColor[index].color!;
                            if(colorValue.length >= 7){
                              colorString = '0xff${colorValue.substring(1, 7)}';
                            }
                          }
                          ...
                          return Padding(
                            ...
                            GestureDetector(
                              ...
                              child: Stack(children: [
                                ...
                                Positioned.directional(textDirection: Directionality.of(context), start: 10, top: 10,
                                ...
                                if(addProductImageController.imagesWithColor[index].colorImage?.imageName?.path != null && addProductImageController.imagesWithColor[index].colorImage?.imageName?.path != '')
                                Positioned.directional(textDirection: Directionality.of(context), end: 10, top: 10,
