...
class _TitleAndDescriptionWidgetState extends State<TitleAndDescriptionWidget> {
  ...
  Widget build(BuildContext context) {
    final String titleText = widget.index < widget.resProvider.titleControllerList.length
        ? widget.resProvider.titleControllerList[widget.index].text
        : '';
    final String descriptionText = widget.index < widget.resProvider.descriptionControllerList.length
        ? widget.resProvider.descriptionControllerList[widget.index].text
        : '';
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Consumer<AiController>(
          ...
          CustomTextFieldWidget(
            ...
            borderColor: Theme.of(context).primaryColor.withValues(alpha: .25),
                            onChanged: (String text) {
                              if (widget.index < widget.resProvider.titleControllerList.length) {
          ...
          CustomTextFieldWidget(
            ...
            onChanged: (String text) {
              if (widget.index < widget.resProvider.descriptionControllerList.length) {
