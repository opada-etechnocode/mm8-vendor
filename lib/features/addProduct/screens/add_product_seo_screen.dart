                                  ...
                                  childrens: [
                                    ...
                                    Consumer<AddProductImageController>(
                                      builder: (context, addProductImageController, child){
                                        return Align(alignment: AlignmentDirectional.topStart, child: Stack(children: [
                                          Padding(
                                ...
                                return Container(height: 72,
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: CustomButtonWidget(
                                          btnTxt: _update ? getTranslated('update',context) : getTranslated('submit', context), buttonHeight: 48,
                                          borderRadius: 12,
                                          onTap: () async {
