...
class AddProductScreenState extends State<AddProductScreen> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  ProductGeneralInfoData getCurrentFormData() {
    ...
    return ProductGeneralInfoData(
      categoryId: categoryController.categoryIndex != 0 && categoryController.categoryList != null && categoryController.categoryIndex! <= categoryController.categoryList!.length ? categoryController.categoryList![categoryController.categoryIndex!-1].id.toString() : '-1',
      subCategoryId: categoryController.subCategoryIndex != 0 && categoryController.subCategoryList != null && categoryController.subCategoryIndex! <= categoryController.subCategoryList!.length
        ? categoryController.subCategoryList![categoryController.subCategoryIndex!-1].id.toString()
        : "-1",
      subSubCategoryId: (categoryController.subSubCategoryIndex != 0 && categoryController.subSubCategoryIndex! != -1 && categoryController.subSubCategoryList != null && categoryController.subSubCategoryIndex! <= categoryController.subSubCategoryList!.length)
      ...
      brandId: Provider.of<SplashController>(Get.context!, listen: false).configModel!.brandSetting == "1" && resProvider.productTypeIndex != 1
        && brandIds.isNotEmpty && productController.brandIndex != null && productController.brandIndex! < brandIds.length
      ...
      title: resProvider.titleControllerList.isNotEmpty ? resProvider.titleControllerList[0].text.trim() : '',
      description: resProvider.descriptionControllerList.isNotEmpty ? resProvider.descriptionControllerList[0].text.trim() : '',
    );
  }
                    ...
                    children: [
                                      ...
                                      child: Column(
                                        children: [
                                          Padding(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsetsDirectional.only(top: Dimensions.paddingSizeMedium, start: Dimensions.paddingEye, bottom: Dimensions.paddingEye),
                                            ...
                                            return GridView.builder(
                                              ...
                                              itemBuilder: (BuildContext context, index){
                                                return Stack(children: [
                                                  ...
                                                  Positioned.directional(textDirection: Directionality.of(context), top: 5, end: 5, child: InkWell(
                                                    splashColor: Colors.transparent,
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: (keyboardHeight > 0 &&  (_publishingFocus.hasFocus || _authorFocus.hasFocus)) ? null : Border(
                            top: BorderSide(color: Theme.of(context).hintColor.withValues(alpha: 0.10)),
                          ),
                        ),
                        child: (keyboardHeight > 0 &&  (_publishingFocus.hasFocus || _authorFocus.hasFocus)) ? const SizedBox() : Consumer<AddProductController>(
                          builder: (context,resProvider, _) {
                            return !resProvider.isLoading? SizedBox(height: 48,
                                  ...
                                  return Consumer<AiController>(
                                    builder: (context, aiController, _) {
                                      return InkWell(
                                        ...
                                        Container(width: MediaQuery.of(context).size.width, height: 48,
