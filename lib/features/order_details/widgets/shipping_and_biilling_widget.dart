...
class _ShippingAndBillingWidgetState extends State<ShippingAndBillingWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool hasBillingAddress = widget.orderModel?.billingAddressData?.hasDisplayableValues ?? false;
        ...
        children: [
          Container(
            color: Theme.of(context).cardColor,
              ...
              if(hasBillingAddress &&  widget.orderModel?.shippingAddressData != null &&
                    ...
                    return GestureDetector(onTap: (){
                      ...
                      child: Row(children: [
                        ...
                        Padding(
                          ...
                          child: Image.asset(Images.showOnMap, width: Dimensions.iconSizeDefault,color: Theme.of(context).primaryColor,)
                        ),
                      ]),
                    );
                  }
