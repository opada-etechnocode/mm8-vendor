          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Padding(padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeMedium, Dimensions.paddingSizeSmall, Dimensions.paddingSizeMedium, Dimensions.paddingSizeDefault),
                  child: Container(
        ...
        builder: (context, shop,_) {
          return Container(
            ...
            decoration: BoxDecoration(
              color: Theme.of(context).cardColor,
              borderRadius: BorderRadius.circular(12),
              border: showBorder ? Border.all(color: borderColor ?? Theme.of(context).hintColor.withValues(alpha: 0.12), width: 1) : null,
            ),
            child: Row(children: [
