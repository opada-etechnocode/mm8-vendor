...
import 'package:sixvalley_vendor_app/features/shop/widgets/shop_details_shimmer.dart';
      ...
      builder: (context, shop,_) {
        return Container(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
          decoration: BoxDecoration(
            ...
            border: Border.all(color: Theme.of(context).hintColor.withValues(alpha:.12))),
          child: Row(children: [
