...
class _ProductViewWidgetState extends State<ProductViewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final String languageCode = Provider.of<LocalizationController>(context, listen: false).locale.languageCode == 'US'
        ? 'en'
        : Provider.of<LocalizationController>(context, listen: false).locale.countryCode!.toLowerCase();
    ...
    return RefreshIndicator(
      onRefresh: () async {
        Provider.of<ProductController>(context, listen: false).getSellerProductList(
          Provider.of<ProfileController>(context, listen: false).userId.toString(), 1,
          languageCode, '', filterSearchModel: Provider.of<ProductController>(context, listen: false).filterModel);
      },
        ...
        builder: (context, prodProvider, child) {
          return Stack(
              children: [
                ...
                Positioned.fill(
                  child: SingleChildScrollView(
                    ...
                    child: PaginatedListViewWidget(
                      ...
                      limit: prodProvider.sellerProductModel?.limit ?? 50,
                      ...
                      onPaginate: (int? offset) async {
                        await prodProvider.getSellerProductList(
                          userId, offset!, languageCode, prodProvider.sellerProductModel?.search ?? '',
                ...
                ) : const Positioned.fill(child: NoDataScreen()) : const Positioned.fill(child: OrderShimmer()),
                   ...
                   Positioned(
                     ...
                     child: Align(
                       ...
                       child: ScrollingFabAnimated(
                         ...
                         icon: SizedBox(width: Dimensions.iconSizeExtraLarge,child: Image.asset(Images.addIcon,color: Theme.of(context).primaryColor,)),
