    ...
    return Consumer<ProductController>(
      builder: (context, prodProvider, child) {
        ...
        return Column(children: [
          ...
          Padding(padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeMedium, Dimensions.paddingSizeMedium, Dimensions.paddingSizeMedium, Dimensions.paddingSizeSmall),
            child: Row(children: [
          ...
          isHome ? SizedBox(
            ...
            child: ListView.builder(
              ...
              padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeSmall, 0, Dimensions.paddingSizeSmall, Dimensions.paddingSizeMedium),
          ...
          ): isHome ? const SizedBox() : const Expanded(child: NoDataScreen()) : isHome ? const SizedBox() : const Expanded(child: OrderShimmer()),
